...
export default function Home(
  ...
  return (
    ...
    <div id='contact' className='h-fit flex flex-col bg-cool-black pl-10 pr-10 lg:pl-64 lg:pr-64 xl:pr-80 xl:pl-80 pb-20 pt-10'>
      <h1 className='self-center font-bold text-xl sm:text-2xl'>You can contact me via my Socials </h1>
      <div className='flex flex-row gap-5 mt-8 self-center'>
      ...
      <p className='self-center font-bold text-lg sm:text-xl mt-10'>Or you can send me a message</p>
