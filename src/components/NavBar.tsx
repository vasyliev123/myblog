...
<nav className="bg-cool-black-dark dark:bg-gray-700 dark:text-white fixed w-full z-20 top-0 start-0 transition-all h-20  ">
  ...
  <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white">Dmytro Vasyliev</span>
  </Link>
